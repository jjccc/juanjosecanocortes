...
set :application, "juanjosecanocortes"
set :deploy_to, "/home/juanjosecanocortes"
set :repository,  "git@github.com:jjccc/juanjosecanocortes.git"

set :scm, :git
default_run_options[:pty] = true
set :user, "root"
set :domain, "juanjosecanocortes.com"
set :use_sudo, false
...
DocumentRoot #{File.join(deploy_to, 'current', 'public')}
  ...
  task :secret_token, :role => :app do
    ...
    system "rsync -vr --exclude='.DS_Store' config/application.yml #{user}@#{remote_host}:#{release_path}/config/"
  end
